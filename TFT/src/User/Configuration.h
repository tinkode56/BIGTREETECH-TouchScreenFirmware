 ...
 *
 */
#define DEFAULT_LCD_BRIGHTNESS      5  // 10: LCD_100_PERCENT - Brightness value from list
#define DEFAULT_LCD_IDLE_BRIGHTNESS 0   // 2: LCD_10_PERCENT - Brightness value from list
